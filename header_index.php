...
<header>
    <div class="container nav-shell">
        ...
        <nav class="nav-center">
            <a href="/bibliothéque/index.php">Accueil</a>
            <a href="/bibliothéque/index.php#apropos">A propos</a>
            <a href="/bibliothéque/index.php#contact">Contact</a>
        ...
        <!-- 🔹 BOUTONS POUR CHANGER DE THÈME (COOKIES) 🔹 -->
        <div class="theme-buttons">
            <button class="btn-theme btn-theme-light" onclick="changerTheme('light')" title="Thème clair">☀️</button>
            <button class="btn-theme btn-theme-dark" onclick="changerTheme('dark')" title="Thème sombre">🌙</button>
        </div>
        ...
        // 🔹 FONCTIONS POUR LES COOKIES (thème) 🔹
        function sauvegarderTheme(theme) {
            fetch('/bibliotheque/cookies/prefs.php', {
                method: 'POST',
        ...
        function chargerPreferences() {
            fetch('/bibliotheque/cookies/prefs.php')
                ...
                .catch(error => console.error('Erreur chargement préférences:', error));
        }
...
<!-- 🔹 AJOUTER LE SCRIPT API À LA FIN DU BODY (à mettre juste avant </body>) 🔹 -->
<script src="/bibliotheque/js/api.js"></script>
</body>
</html>